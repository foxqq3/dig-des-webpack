...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addPage)\n/* harmony export */ });\n/* harmony import */ var _js_helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/js/helpers.js */ \"./src/js/helpers.js\");\n/* harmony import */ var _js_components_navigation_panel_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/js/components/navigation-panel/index.js */ \"./src/js/components/navigation-panel/index.js\");\n/* harmony import */ var _js_test_variables_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/js/test-variables.js */ \"./src/js/test-variables.js\");\n/* harmony import */ var _js_events_events_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/js/events/events.js */ \"./src/js/events/events.js\");\n//helper\n\n//components\n\n\n//variables for test\n\n//event functions\n\nfunction addPage() {\n  var app = document.querySelector('#app');\n  var page = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('div', {\n    className: 'page'\n  });\n  var sectionItmes = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('div', {\n    className: 'page__section-items'\n  });\n  page.appendChild((0,_js_components_navigation_panel_index_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(_js_test_variables_js__WEBPACK_IMPORTED_MODULE_2__.menuItems));\n  page.appendChild(sectionItmes);\n  app.appendChild(page);\n  (0,_js_events_events_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n\n  //Buttons////////////////////\n  var button1 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-create',\n    textContent: 'Создать XML'\n  });\n  var button2 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-get',\n    textContent: 'Получить XML'\n  });\n  var button3 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-set',\n    textContent: 'Редактировать XML'\n  });\n  var button4 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-del',\n    textContent: 'Удалить XML'\n  });\n  sectionItmes.appendChild(button1);\n  sectionItmes.appendChild(button2);\n  sectionItmes.appendChild(button3);\n  sectionItmes.appendChild(button4);\n  ////////////////////////////////////////\n\n  var button5 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-create-task',\n    textContent: 'Создать XML'\n  });\n  var button6 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-get-task',\n    textContent: 'Получить XML'\n  });\n  var button7 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-set-task',\n    textContent: 'Редактировать XML'\n  });\n  var button8 = (0,_js_helpers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])('button', {\n    className: 'button  button_primary_default js-del-task',\n    textContent: 'Удалить XML'\n  });\n  sectionItmes.appendChild(button5);\n  sectionItmes.appendChild(button6);\n  sectionItmes.appendChild(button7);\n  sectionItmes.appendChild(button8);\n  ////////////////////////////////////////\n}\n\n//# sourceURL=webpack://dig-des-webpack/./src/js/components/pages/add-page.js?");
...
/***/ "./src/js/data-requests/create-project-xhr.js":
/*!****************************************************!*\
  !*** ./src/js/data-requests/create-project-xhr.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ createProject)\n/* harmony export */ });\nfunction createProject() {\n  var xhr = new XMLHttpRequest();\n  var requestUrl = \"http://45.12.239.156:8081/api/projects\";\n  xhr.open('POST', requestUrl);\n  xhr.responseType = 'json';\n  xhr.setRequestHeader('authorization', \"Bearer \".concat(localStorage.getItem('token')));\n  xhr.setRequestHeader('Content-Type', 'application/json');\n  var data = {\n    name: 'Первое название',\n    code: 'Первый код'\n  };\n  xhr.onload = function () {\n    if (xhr.status === 200) {\n      console.log(xhr.response);\n      localStorage.setItem('_id-project', xhr.response._id);\n      localStorage.setItem('_id-author', xhr.response.author);\n    } else {\n      xhr.response;\n    }\n  };\n  xhr.send(JSON.stringify(data));\n}\n\n//# sourceURL=webpack://dig-des-webpack/./src/js/data-requests/create-project-xhr.js?");

/***/ }),

/***/ "./src/js/data-requests/create-task-xhr.js":
/*!*************************************************!*\
  !*** ./src/js/data-requests/create-task-xhr.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ delProject)\n/* harmony export */ });\nfunction delProject() {\n  var xhr = new XMLHttpRequest();\n  var id = localStorage.getItem('_id-project');\n  var requestUrl = \"http://45.12.239.156:8081/api/projects/\".concat(id);\n  xhr.open('DELETE', requestUrl);\n  xhr.responseType = 'json';\n  xhr.setRequestHeader('authorization', \"Bearer \".concat(localStorage.getItem('token')));\n  xhr.setRequestHeader('Content-Type', 'application/json');\n  xhr.onload = function () {\n    if (xhr.status === 200) {\n      console.log(xhr.response);\n    } else {\n      console.log(xhr.response);\n    }\n  };\n  xhr.send();\n}\n\n//# sourceURL=webpack://dig-des-webpack/./src/js/data-requests/del-project-xhr.js?");

/***/ }),

/***/ "./src/js/data-requests/get-project-xhr.js":
/*!*************************************************!*\
  !*** ./src/js/data-requests/get-project-xhr.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ createProject)\n/* harmony export */ });\nfunction createProject() {\n  var xhr = new XMLHttpRequest();\n  var id = localStorage.getItem('_id-project');\n  var requestUrl = \"http://45.12.239.156:8081/api/projects/\".concat(id);\n  xhr.open('GET', requestUrl);\n  xhr.responseType = 'json';\n  xhr.setRequestHeader('authorization', \"Bearer \".concat(localStorage.getItem('token')));\n  xhr.setRequestHeader('Content-Type', 'application/json');\n  xhr.onload = function () {\n    if (xhr.status === 200) {\n      console.log(xhr.response);\n    } else {\n      console.log(\"\\u0412\\u043E\\u0437\\u043D\\u0438\\u043A\\u043B\\u0430 \\u043E\\u0448\\u0438\\u0431\\u043A\\u0430 \".concat(xhr.status, \" \").concat(xhr.statusText, \" \"));\n    }\n  };\n  xhr.send();\n}\n\n//# sourceURL=webpack://dig-des-webpack/./src/js/data-requests/get-project-xhr.js?");

/***/ }),

/***/ "./src/js/data-requests/set-project-xhr.js":
/*!*************************************************!*\
  !*** ./src/js/data-requests/set-project-xhr.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ setProject)\n/* harmony export */ });\nfunction setProject() {\n  var xhr = new XMLHttpRequest();\n  var requestUrl = \"http://45.12.239.156:8081/api/projects\";\n  xhr.open('PUT', requestUrl);\n  xhr.responseType = 'json';\n  xhr.setRequestHeader('authorization', \"Bearer \".concat(localStorage.getItem('token')));\n  xhr.setRequestHeader('Content-Type', 'application/json');\n  var data = {\n    name: 'Второе название',\n    code: 'Второй код',\n    _id: localStorage.getItem('_id-project')\n  };\n  xhr.onload = function () {\n    if (xhr.status === 200) {\n      console.log(xhr.response);\n    } else {\n      xhr.response;\n    }\n  };\n  xhr.send(JSON.stringify(data));\n}\n\n//# sourceURL=webpack://dig-des-webpack/./src/js/data-requests/set-project-xhr.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_components_pages_add_page_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/js/components/pages/add-page.js */ \"./src/js/components/pages/add-page.js\");\n/* harmony import */ var _scss_index_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/scss/index.scss */ \"./src/scss/index.scss\");\n/* harmony import */ var _js_data_requests_add_data_requests_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/js/data-requests/add-data-requests.js */ \"./src/js/data-requests/add-data-requests.js\");\n/* harmony import */ var _js_data_requests_create_project_xhr_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/js/data-requests/create-project-xhr.js */ \"./src/js/data-requests/create-project-xhr.js\");\n/* harmony import */ var _js_data_requests_get_project_xhr_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/js/data-requests/get-project-xhr.js */ \"./src/js/data-requests/get-project-xhr.js\");\n/* harmony import */ var _js_data_requests_set_project_xhr_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/js/data-requests/set-project-xhr.js */ \"./src/js/data-requests/set-project-xhr.js\");\n/* harmony import */ var _js_data_requests_del_project_xhr_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/js/data-requests/del-project-xhr.js */ \"./src/js/data-requests/del-project-xhr.js\");\n/* harmony import */ var _js_data_requests_create_task_xhr__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/js/data-requests/create-task-xhr */ \"./src/js/data-requests/create-task-xhr.js\");\n\n\n\n\n\n\n\n\n(0,_js_components_pages_add_page_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\nlocalStorage.clear();\nvar requestUrl = \"http://45.12.239.156:8081/api/projects\";\nvar authorizationData = {\n  login: 'rozhdestvensky.d',\n  password: 'jc63fk'\n};\n\n//Token\n(0,_js_data_requests_add_data_requests_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\napp.addEventListener('click', function (event) {\n  var element = event.target;\n  if (element.closest('.js-create')) {\n    (0,_js_data_requests_create_project_xhr_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  } else if (element.closest('.js-get')) {\n    (0,_js_data_requests_get_project_xhr_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  } else if (element.closest('.js-set')) {\n    (0,_js_data_requests_set_project_xhr_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])();\n  } else if (element.closest('.js-del')) {\n    (0,_js_data_requests_del_project_xhr_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\n  } else if (element.closest('.js-create-task')) {\n    (0,_js_data_requests_create_task_xhr__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\n  } else if (element.closest('.js-get-task')) {}\n});\n\n//# sourceURL=webpack://dig-des-webpack/./src/js/index.js?");
